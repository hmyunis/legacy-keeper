...
import { useVibeSearch } from '../hooks/useSearch';
...
export default function SearchPage() {
  ...
  const [results, setResults] = useState<VaultMemory[]>([]);
    ...
    <div className="min-h-screen zone-light pt-[120px] pb-24 px-[clamp(24px,5vw,80px)] flex flex-col relative overflow-hidden">
      ...
      <div className={`max-w-[800px] mx-auto w-full transition-all duration-700 ease-[var(--ease-out)] ${hasSearched ? 'mb-12 scale-95' : 'mb-24 mt-[10vh] scale-100'}`}>
        ...
        <motion.form
          ...
          className={`relative z-20 transition-all duration-500 rounded-full ${isFocused || searchMutation.isPending ? 'shadow-[var(--shadow-gold)] scale-[1.02]' : 'shadow-[var(--shadow-lg)] scale-100'}`}
        >
