...
const BEFORE_URL = 'https://images.unsplash.com/photo-1542038784456-1ea8e935640e?w=1200&q=30';
const AFTER_URL = 'https://images.unsplash.com/photo-1542038784456-1ea8e935640e?w=1200&q=80';

export default function RestorationSlider({ onClose }: RestorationSliderProps) {
    ...
    <div className="fixed inset-0 z-[100] bg-[rgba(14,12,11,0.95)] backdrop-blur-md flex items-center justify-center p-4 lg:p-8">
      ...
      <div className="max-w-6xl w-full">
        <div className="text-center mb-6">
          ...
          <h2 className="font-display font-semibold text-[2rem] text-[var(--clr-linen)] mb-2">Photo Restoration</h2>
        ...
        <div className="flex justify-center gap-4 mt-6">
          <button className="flex items-center gap-2 px-6 py-3 rounded-full bg-[var(--clr-gold)] text-[var(--clr-linen)] font-ui font-bold text-xs uppercase tracking-widest hover:bg-[var(--clr-gold-light)] transition-colors">
            <ArrowClockwise size={16} /> Apply to Gallery
          </button>
          <button className="flex items-center gap-2 px-6 py-3 rounded-full border border-[rgba(184,143,91,0.3)] text-[var(--clr-fog)] font-ui font-bold text-xs uppercase tracking-widest hover:border-[var(--clr-gold)] hover:text-[var(--clr-gold)] transition-colors">
