...
urlpatterns = [
    ...
    path('<uuid:vault_id>/memories/collections/', views.MemoryCollectionListCreateView.as_view(), name='memory-collections'),
    path('<uuid:vault_id>/memories/collections/<uuid:collection_id>/', views.MemoryCollectionDetailView.as_view(), name='memory-collection-detail'),
