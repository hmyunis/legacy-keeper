...
urlpatterns = [
    ...
    path('shares/', views.SharedArtifactCreateView.as_view(), name='shared-artifact-create'),
    path('shares/<str:token>/', views.SharedArtifactResolveView.as_view(), name='shared-artifact-resolve'),
