...
import { X, Calendar, ShieldCheck, Plus, Trash2, Share2, Heart, MapPin, Download, Loader2 } from 'lucide-react';
...
const MediaDetailModal: React.FC<MediaDetailModalProps> = ({
  ...
  const handleDownload = () => {
    downloadMediaMutation.mutate({ mediaItem: media });
  };
              ...
              <div className="flex flex-wrap gap-2">
                ...
                {canEdit && (
                  <button
                    ...
                    className="px-3 py-1.5 border border-dashed border-slate-300 dark:border-slate-700 rounded-xl text-[10px] font-bold text-slate-400 hover:text-primary transition-all"
                  >
